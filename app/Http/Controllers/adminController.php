...
class adminController extends Controller
{
      ...
      public function add_catagory(Request $request){
        ...
        $data->save();
        return redirect()->back()->with('message', 'add catagory successfully');
      }
       ...
       public function delete_catagory($id){
        ...
        $data->delete();
        return redirect()->back()->with('message', 'Delete catagory successfully');
      ...
      public function add_product(Request $request){
       ...
       $request->image->move('product',$iamgeName);
